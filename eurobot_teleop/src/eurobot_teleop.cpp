...
EurobotTeleop::EurobotTeleop(const std::string & name)
    : rclcpp::Node(name, rclcpp::NodeOptions().use_intra_process_comms(true))
{
    ...
    joy_subscriber_ = create_subscription<sensor_msgs::msg::Joy>(joy_topic, 10, std::bind(&EurobotTeleop::on_joy_message, this, std::placeholders::_1));
}

void EurobotTeleop::on_joy_message(std::unique_ptr<sensor_msgs::msg::Joy> msg)
{
...
double EurobotTeleop::get_axis_value(std::unique_ptr<sensor_msgs::msg::Joy> & msg, AxisConfig& config)
{
