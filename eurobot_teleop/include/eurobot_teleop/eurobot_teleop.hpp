...
#ifndef __DEBICT_EUROBOT_TELEOP__EUROBOT_TELEOP_H__
#define __DEBICT_EUROBOT_TELEOP__EUROBOT_TELEOP_H__
...
namespace debict
{
    namespace eurobot
    {
        namespace teleop
        {
            ...
            public:
                EurobotTeleop(const std::string & name);
...
#endif // __DEBICT_EUROBOT_TELEOP__EUROBOT_TELEOP_H__